...
export default compose(
    connect<MapStatePropsType, MapDispatchStatePropsType, OwnPropsType, AppStateType>(f1,{follow, unfollow, getUsers: getUsersThunkCreator, setCurrentPage,  toggleFollowingInProgress}),
    )(UsersApi)
