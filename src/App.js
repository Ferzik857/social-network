...
<div className="app-warpper-content">
  <Route path="/Profile" render={() => <Profile PostData={props.PostData} addPost={props.addPost} newPostText={props.newPostText} updateNewPostText={props.updateNewPostText} />}/>
